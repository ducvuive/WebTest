...
namespace Test.Controllers
{
    public class CongketnoiController : Controller
    {
        ...
        // GET: Congketnoi/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Congketnoi/Create
